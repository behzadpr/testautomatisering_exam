...
def before_scenario(context, scenario):
    # The scenario fixture is created from a feature file, we don't
    # typically need it for anything.
    # Open a new page, to prevent cookies to leak between tests. Set
